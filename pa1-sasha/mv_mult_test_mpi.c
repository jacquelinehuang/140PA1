...
int mat_vect_mult (double *, double *, double *, int, int, int, int,
                   MPI_Comm);
 ...
 */
char *
validate_vect (double y[], int blocksize, int n, int c)
{
  int i,
    local_i;
...
int
allocate_space (double **local_A, double **local_x, double **local_y,
                int blocksize, int n)
{
  int succ = 1,
    all_succ = 1;
...
char *
mv_test (char *testmsg, int n, int c)
{
  double startwtime = 0,
    endwtime = 0;
  double *local_A,
  ...
  succ =
    mat_vect_mult (local_A, local_x, local_y, blocksize, n, my_rank, no_proc,
                   comm);
